    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-6">
        ...
        <div class="p-5 mb-6 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
            ...
            <div class="flex items-center justify-between w-full">
                ...
                @if ($orangtua !== null)
                    <a href="{{ route('form.orang-tua.edit') }}">
                        <button
                            class="flex w-full items-center justify-center gap-2 rounded-full border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200 lg:inline-flex lg:w-auto">
                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                @if ($orangtua === null)
                    <div
                        class="flex flex-col items-center justify-center w-full gap-4 p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
                        <p class="text-xl my-5 text-gray-500 dark:text-gray-400">Data Kosong</p>
                        <h1 class="text-sm font-medium text-gray-800 dark:text-white/90">Jika data kosong silahkan isis
                            data orang tua anda terlebuh dahulu untuk melanjutkan pendaftaran</h1>
                        <button
                            ...
                            <a href="{{ route('form.personal.index') }}">Isi Data Diri Orang Tua</a>
                        </button>
                    </div>
                @else
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
