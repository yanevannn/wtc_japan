...
<body>
    ...
    <table class="info-table">
        <tbody>
            ...
            <tr>
                <td class="label"><strong>Gelombang Seleksi</strong></td>
                <td class="value">: {{ $data->siswa->gelombang->nama_gelombang }}</td>
            </tr>
            <tr>
                <td class="label"><strong>Tahun</strong></td>
                <td class="value">: {{ $data->siswa->gelombang->tahun }}</td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="nilai-table">
        ...
        <tbody>
            ...
            <tr>
                <td>1</td>
                <td>{{ $data->huruf_jepang }}</td>
                <td>{{ nilaiHuruf($data->huruf_jepang) }}</td>
            </tr>
            <tr>
                <td>2</td>
                <td>{{ $data->matematika }}</td>
                <td>{{ nilaiHuruf($data->matematika) }}</td>
            </tr>
            <tr>
                <td>3</td>
                <td>{{ $data->fisik }}</td>
                <td>{{ nilaiHuruf($data->fisik) }}</td>
            </tr>
            <tr>
                <td>4</td>
                <td>{{ $data->koran }}</td>
                <td>{{ nilaiHuruf($data->koran) }}</td>
            </tr>
        </tbody>
    </table>
