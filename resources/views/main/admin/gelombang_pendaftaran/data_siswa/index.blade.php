    ...
    <div class="space-y-5 sm:space-y-6">
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="px-5 py-4 sm:px-6 sm:py-5 flex items-center justify-between">
                ...
                <a href="{{ route('gelombang.data-siswa.download-template', $gelombang->id) }}"
            ...
            <div class="p-5 border-t border-gray-100 dark:border-gray-800 sm:p-6">
                <div class="mb-2">
                    ...
                    <form action="{{ route('gelombang.data-siswa.upload-nilai', $gelombang->id) }}" method="POST"
                        ...
                        <div>
                            <label for="nilai_file"
                                ...
                                Upload File Nilai Seleksi {{ $gelombang->nama_gelombang }}
                            </label>
