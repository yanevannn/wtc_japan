                        ...
                        @else
                            @foreach ($data as $sesi_interview)
                                <tr>
                                    ...
                                    <x-table-cell
                                        class="justify-center">{{ \Carbon\Carbon::parse($sesi_interview->jam_mulai)->format('H:i') }}
                                        - {{ \Carbon\Carbon::parse($sesi_interview->jam_selesai)->format('H:i') }}
                                    </x-table-cell>
                                    ...
                                    <x-table-cell class="justify-center">{{$sesi_interview->pendaftaranInterview->count() }}</x-table-cell>
                                    <x-table-cell>
