    ...
    <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
        ...
        <a href="{{ route('dashboard') }}">
            <span class="logo" :class="sidebarToggle ? 'hidden' : ''">
                ...
                <h1 class="text-2xl font-bold hidden dark:block text-white">WTC <span style="color:#d3e227">2</span> JAPAN</h1>
            </span>
            {{-- <img class="logo-icon" :class="sidebarToggle ? 'lg:block' : 'hidden'" src="src/images/logo/logo-icon.png" alt="Logo" /> --}}
            <h1 class="logo-icon text-2xl font-bold dark:text-white" :class="sidebarToggle ? 'lg:block' : 'hidden'">W<span style="color:#d3e227">T</span>C</h1>
